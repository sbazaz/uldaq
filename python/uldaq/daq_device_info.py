...
class DaqDeviceInfo:
    ...
    def get_product_id(self):
        # type: () -> int
        """
        Gets the product ID associated with the DAQ device.
    ...
    def get_mem_info(self):
        # type: () -> DevMemInfo
        """
        Gets the information about the memory regions for the DAQ device.

        Returns:
            An instance of the device memory information object
            :class:`DevMemInfo` that contains information
