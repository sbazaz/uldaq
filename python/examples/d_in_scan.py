...
"""
    ...
    7. Call dio_device.d_in_scan() to start the scan of digital input port
...
def main():
    ...
    try:
        ...
        print('    Rate: ', rate, ' Hz')
        print('    Scan options:', display_scan_options(dio_info.get_scan_options(DigitalDirection.INPUT),
                                                        scan_options))
        ...
        while True:
            ...
            if transfer_status.current_index >= 0:
                ...
                index = transfer_status.current_index - (5 * number_of_ports)
                ...
                for i in range(number_of_ports):
                    print('port =',
                          ...
                          '{:d}'.format(data[index + i + (number_of_ports * 1)]),
                          '{:d}'.format(data[index + i + (number_of_ports * 2)]),
                          '{:d}'.format(data[index + i + (number_of_ports * 3)]),
                          '{:d}'.format(data[index + i + (number_of_ports * 4)]))
