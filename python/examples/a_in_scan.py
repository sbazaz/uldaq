...
"""
    ...
    Purpose:                          Performs a continuous scan of the A/D
                                      input channels
    ...
    7. Call ai_device.a_in_scan() to start the scan of A/D input channels
    8. Display the last 5 samples for each channel as long as scan is running
"""
